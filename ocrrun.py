...
def ocr_apply(pil_image, output_dir):
    ...
    extension = ".txt"
    counter = 1
    output_filename = os.path.join(output_dir, f"{base_filename}{counter}{extension}")
    ...
    while os.path.exists(output_filename):
        ...
        # while os.path.exists(os.path.join(output_dir, f"{base_filename}{counter}{extension}")):
    #    counter += 1
    # output_filename = os.path.join(output_dir, f"{base_filename}{counter}{extension}")
